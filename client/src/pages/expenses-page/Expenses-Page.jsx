...
export default function ExpensesPage() {
  ...
  const [managerOptions, setManager] = useState([
    { label: "pedritosola@gmail.com" },
  ]);
  ...
  const deleteButton = (params) => {
    if (
      confirm("¿Está seguro que desea eliminar el registro " + params.id + "?")
    ) {
      fetch(url, {
        method: "DELETE",
        headers: {
